...
## Technologies 
This project is fully open source and everybody can have a look the code structure of it. I aimed to create a good-looking web app with React, Bootstrap 4, React-Bootstrap, Eslint, Prettier, Normalize, SASS, HTML, CSS and Redux.  
