...
const Historia = () => (
  <div className="container">
    ...
    <p>
      ...
      missbrukar eller är kriminella. Vision Center Haninge har funnits sedan 2009 och har nu en
      stark förankring i lokalsamhället med goda kontakter med kommun, socialtjänst, kultur- och
