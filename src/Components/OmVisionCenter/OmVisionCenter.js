...
const OmVisionCenter = () => (
  <div className="container col-md-9">
    ...
    <p className="">
      Vi har kunskapen att se vilka ungdomar som är i gråzonen. De fångas upp av våra unga ledare i
      samarbete med ungdomsledaren. Genom att ta med dem i olika aktiviteter och där låta dem ta
      ansvar så leder vi dem mot stärkt självkänsla. Vi ger dem också möjligheten till
      arbetsträning/anställning. Många av dessa ungdomar har även via oss fått Ledarutbildning,
      HLR-utbildning (hjärt- och lungräddning), Miljöutbildning samt Säkerhetsutbildning. Vi har
      klart sett hur vårt arbete med dessa ungdomar har lyckats. De har blivit ansvarstagande starka
      individer.
    </p>
    <p className="">
